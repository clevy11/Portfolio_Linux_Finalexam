        ...
        if (projects && projects.length > 0) {
            ...
            projects.forEach(project => {
                ...
                projectCard.innerHTML = `
                    <img src="${project.image || 'images/default-project.jpg'}" onerror="this.src='images/default-project.jpg'" alt="${project.title}" class="project-image" onerror="this.src='images/default-project.jpg'">
